...
<div class="alert alert-success fade in" id="alert">
    ...
    <strong>Error!</strong> {{session('ptcnttru')}}
</div>
{{Session::forget('ptcnttru');}}
@endif

@if (session('ptcntfls'))
<div class="alert alert-danger fade in" id="alert">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Error!</strong> {{session('ptcntfls')}}
</div>
{{Session::forget('ptcntfls');}}
@endif
    ...
    <form action="contact" method="POST" id="contact_form">
      ...
      <div class="subject">
        ...
        <select placeholder="Subject line" name="subject" id="subject_input" required data-parsley-required-message="Please select subject" >
          ...
          <option value="Related to tratement issue">Related to tratement issue</option>
